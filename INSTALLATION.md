...
$ helm install ./api/helm --name instemmingservice --kubeconfig="api/helm/kubeconfig.yaml"

Or update if you want to update an existing one
$ helm upgrade instemmingservice  ./api/helm --kubeconfig="api/helm/kubeconfig.yaml" 

Or del if you want to delete an existing  one
$ helm del instemmingservice  --purge --kubeconfig="api/helm/kubeconfig.yaml" 

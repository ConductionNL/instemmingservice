...
$ helm install ./api/helm --name irc --kubeconfig="api/helm/kubeconfig.yaml"

Or update if you want to update an existing one
$ helm upgrade irc  ./api/helm --kubeconfig="api/helm/kubeconfig.yaml" 

Or del if you want to delete an existing  one
$ helm del irc  --purge --kubeconfig="api/helm/kubeconfig.yaml" 

...
class WebHookSubscriber implements EventSubscriberInterface
{
    ...
    public function __construct(ParameterBagInterface $params, AssentService $trouwService, CommongroundService $commonGroundService, SerializerInterface $serializer)
    {
        $this->params = $params;
